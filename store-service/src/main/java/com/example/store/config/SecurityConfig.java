...
public class SecurityConfig {
  ...
  @Bean
  @ConditionalOnProperty(prefix="app", name="securityDisabled", havingValue="true", matchIfMissing=false)
  SecurityFilterChain disabledMarker(HttpSecurity http) throws Exception { return http.build(); }
  @Bean
